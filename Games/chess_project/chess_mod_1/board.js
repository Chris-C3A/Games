class Board {
	...
	this.board[0][0] = new Queen(0, 0, 'b');
	...
	this.board[1][0] = new Pawn(1, 0, 'b');
	this.board[1][1] = new Pawn(1, 1, 'b');
	this.board[1][2] = new Pawn(1, 2, 'b');
	this.board[1][3] = new Pawn(1, 3, 'b');
	this.board[1][4] = new Pawn(1, 4, 'b');
	this.board[1][5] = new Pawn(1, 5, 'b');
	this.board[1][6] = new Pawn(1, 6, 'b');
	this.board[1][7] = new Pawn(1, 7, 'b');
	...
	this.board[6][0] = new Pawn(6, 0, 'w');
	this.board[6][1] = new Pawn(6, 1, 'w');
	this.board[6][2] = new Pawn(6, 2, 'w');
	this.board[6][3] = new Pawn(6, 3, 'w');
	this.board[6][4] = new Pawn(6, 4, 'w');
	this.board[6][5] = new Pawn(6, 5, 'w');
	this.board[6][6] = new Pawn(6, 6, 'w');
	this.board[6][7] = new Pawn(6, 7, 'w');
